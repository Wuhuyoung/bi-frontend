...
export async function genChartByAiAsyncUsingPOST(
  ...
  return request<API.BaseResponseAiResponse_>('/api/chart/gen_async', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function genChartByAiAsyncMQUsingPOST(
  ...
  return request<API.BaseResponseAiResponse_>('/api/chart/gen_async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** retryGenChartByAiAsync POST /api/chart/retry_async */
export async function retryGenChartByAiAsyncUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.retryGenChartByAiAsyncUsingPOSTParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseAiResponse_>('/api/chart/retry_async', {
    method: 'POST',
    params: {
      ...params,
    },
